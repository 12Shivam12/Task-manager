    ...
    return (
        <div className='w-[35%]  border border-black m-auto rounded-lg mt-10 poppins'>
            ...
            <form className='flex flex-col gap-10 mt-5 p-5'>
                <input className='border rounded-lg p-2' type="text" placeholder='username...' />
                ...
                <input className='border rounded-lg p-2 bg-black text-white font-normal text-lg cursor-pointer' type='button' value='Signup' />
            </form>
        </div>
    )
}
